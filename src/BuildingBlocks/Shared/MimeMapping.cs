...
/// <summary>
///     Ref to https://github.com/Microsoft/referencesource/blob/master/System.Web/MimeMapping.cs
/// </summary>
[SuppressMessage("ReSharper", "StringLiteralTypo")]
public static class MimeMapping
{
    private static readonly Dictionary<string, string> _mappingDictionary = new(StringComparer.OrdinalIgnoreCase)
    {
        { ".323", "text/h323" },
    ...
    public static string GetMimeMapping(string fileName)
    {
        ...
        for (var i = 0; i < fileName.Length; i++)
        {
            ...
            if (_mappingDictionary.TryGetValue(fileName.Substring(i), out var mimeType))
            {
                return mimeType;
            }
        }
    ...
    {
        var pathSeparatorIndex = path.LastIndexOfAny(_pathSeparatorChars);
