...
public class PathHelper
{
    ...
    public static string ResolvePath(string path)
    {
        ...
        {
            // Leading slashes (e.g. "/Views/Index.cshtml") always generate an empty first token. Ignore these for purposes of resolution.
            pathSegment = pathSegment.Subsegment(1);
        }

        var tokenizer = new StringTokenizer(pathSegment, PathSeparators);
        var requiresResolution = tokenizer.Any(segment => segment.Length == 0
